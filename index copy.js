...
// Rectangle.prototype.topLeft = function() {return {x: this.x, y: this.y}};
// Rectangle.prototype.topRight = function() {return {x: this.x + this.width, y: this.y}};
// Rectangle.prototype.bottomLeft = function() {return {x: this.x, y: this.y + this.height}};
// Rectangle.prototype.bottomRight = function() {return {x: this.x + this.width, y: this.y + this.height}};
// Rectangle.prototype.right = function() {return this.x + this.width};
// Rectangle.prototype.bottom = function() {return this.y + this.height};
// Rectangle.prototype.containsProper = function() {

// }
// Rectangle.prototype.getPosition(p) {
...
// 	return p.y >= this.y && p.y < this.y + this.height && p.x >= this.x
// 			&& p.x < this.x + this.width;
// }
// Rectangle.prototype.containsProper = function(p) {
// 	return p.x > this.x
    ...
    function testOffsetSegmentForIntersections(segment, index, path) {
    	for (var i = 0; i < userObstacles.length; i++) {
    		...
    		if (segment.getSlope() < 0) {
    			if (segment.intersects(obs.x - offset,
    					obs.y - offset,
    					obs.right() + offset,
    					obs.bottom + offset))
    				vertex = getNearestVertex(obs.topLeft(), obs.bottomRight(), segment);
    			else if (segment.intersects(obs.x - offset,
    					obs.bottom()) + offset,
    					obs.right() + offset,
    					obs.y - offset))
